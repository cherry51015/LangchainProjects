...
st.title("Text To Math Problem Solver Uing LLamma ")
...
wiki_tool=Tool(name='Wikipedia',func=wiki_wrapper.run,
               description='A tool for seraching the internet to find the vatious information on the topics mentioned')
...
assistant_agent=initialize_agent(tools=[wiki_tool,calculator,reasoning_tool],
                                 llm=llm,
